...
from .models import Post,Department,File_type
...
class SavePost(forms.ModelForm):
    ...
    file_type=forms.ModelChoiceField(queryset=File_type.objects.all())

    class Meta:
        model = Post
        fields = ('user', 'title', 'department', 'description', 'file_path','file_type')
